...
// TODO Colores
const data: DataItem[] = [
  { name: 'Solicitud', value: 10, fill: '#39b6fe' },
  { name: 'Negociación', value: 30, fill: '#a234f6' },
  { name: 'Otorgamiento', value: 20, fill: '#f45d0b' },
  { name: 'Justificación', value: 2, fill: '#ff47da' },
  { name: 'Cierre', value: 200, fill: '#64e647' }
]
